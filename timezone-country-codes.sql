drop table if exists timezone_country_codes;

create table timezone_country_codes (
    timezone varchar(255) not null,
    country_codes varchar(255) not null
) COMMENT = 'https://en.wikipedia.org/wiki/List_of_tz_database_time_zones';

insert into
    timezone_country_codes (timezone, country_codes)
values
    (
        'Africa/Abidjan',
